...
$(function() {
	$("input,textarea").jqBootstrapValidation(
	{
		...
		submitSuccess: function($form, event) {
			...
			$.ajax({
				type: "POST",
				url: "http://www.verdesrespostas.com/php/contactcode.php",
	...
	//				//clear all fields
				...
				error: function() {	
					// Fail message
					$('#success').html("<div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>Sorry "+firstName+" it seems that my mail server is not responding...</strong> Please email me directly to <a href='mailto:ralf.riedel@usm.edu?Subject=error from MITTFL contact form'>ralf.riedel@usm.edu</a>. Sorry for the inconvenience.</div>");
